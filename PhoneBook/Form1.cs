namespace PhoneBook
{
    public partial class Form1 : Form
    {
        ...
        private void íîâîåToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void óäàëèòüToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                Human human = listView1.SelectedItems[0].Tag as Human;
                if(MessageBox.Show("ÂÛ ÒÎ×ÍÎ ÕÎÒÈÒÅ ÓÄÀËÈÈÒÒÜ??????!!!!?", "Ñòğàøíîå ÍÅ ËÎÌÀÉ ÌÍÅ ßÉÖÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀÀ ÑÓÊÀÀÀÀÀÀÀÀÀÀ ïğåäóïğåæäåíèå", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    db.Remove(human);
